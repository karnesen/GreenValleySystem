...
namespace GreenValleySystem
{
    ...
    public partial class auctionAssessment : System.Web.UI.Page
    {
        ...
        public string state6 = "nav-link";
        public string state7 = "tab-pane fade";
        ...
        public void keepOpen()
        {
            ...
            state6 = "nav-link";
            state7 = "tab-pane fade";
        }


        protected void btnCubeCalc_Click1(object sender, EventArgs e)
        {
            state2 = "tab-pane fade";
            state3 = "tab-pane fade";
            state4 = "nav-link";
            state5 = "nav-link";
